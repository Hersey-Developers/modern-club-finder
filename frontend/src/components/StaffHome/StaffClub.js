...
const StaffClub = ({ sub, activities, handleClick }) => {
  return (
    <div className="text-black mt-5 bg-box phone: w-9/10 tablet:w-9/10 laptop:w-749px desktop: w-749px" style={{ overflow: 'auto', overflowWrap: 'break-word',cursor: "pointer" }}>
