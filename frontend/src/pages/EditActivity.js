...
const EditActivity = () => {
  ...
  return (
    <div>
      <StaffHeader />
      <p className="pt-6 pl-6 text-[#007AFF]">Leave without saving</p>
      <p className="pt-3 pl-6 text-[#007AFF]">Leave and save</p>
      <h1 className="pt-7 pl-6 font-bold text-3xl">Robotics</h1>
      ...
      <p className="pt-6 pl-6 text-[#007AFF] font-bold">Save Changes</p>
    </div>
  );
};
